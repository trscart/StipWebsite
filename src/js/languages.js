let languages = {
    "it-IT": {
        ...
        "whatCaringTitle": "Individua i clienti che abbiano bisogno di assistenza",
        "whatCaringTxt": "Stip scansiona e monitora automaticamente tutti i contenuti prodotti dagli utenti che riguardino la tua azienda, sia all’interno che all’esterno dei canali ufficiali. La piattaforma identifica i contenuti che non necessitano di una risposta da parte della tua azienda, lasciando ai tuoi operatori la possibilità di concentrarsi unicamente sulle richieste da gestire",
        "whatTicketTitle": "Fornire ai tuoi operatori tutte le informazioni di cui hanno bisogno",
        "whatTicketTxt": "Stip interagisce proattivamente con i tuoi clienti in tempo reale e chiede tutte le informazioni che servono ai tuoi operatori per gestire le richieste in maniera efficiente ed efficace. Il tuo staff può continuare a lavorare sul CRM aziendale o utilizzare la nostra pratica piattaforma per la gestione dei ticket",
        "whatRedirectTitle": "Coinvolgi l’operatore perfetto per ogni richiesta",
        "whatRedirectTxt": "Stip capisce le necessità dei tuoi clienti. Reindirizza le loro richieste al dipartimento e all’operatore più competente a gestirle. In questo modo non ci sarà bisogno di dirottare o rispedire le segnalazioni internamente",
        "clientTitle": "Alcune delle aziende con cui lavoriamo:",
        "benefitTitle": "Scopri tu stesso i benefici",
        "benefitSubtitle": "Alcuni risultati dei nostri clienti:",
        "benefitPerformanceTitle": "Crescita delle Prestazioni",
        "benefitPerformanceTxt": "Stip aumenta le performance lavorative dei tuoi operatori del 167%",
        "benefitTimeTitle": "Tempi di Gestione",
        "benefitTimeTxt": "Stip riduce i tempi tra la richiesta del cliente e la sua soluzione dell’80%",
        ...
        "optimizeTitle": "Stip rende più efficiente ed efficace il Customer Care della tua azienda",
        "optimizeSetupTitle": "Facile Configurazione",
        "optimizeSetupTxt": "L’Intelligenza Artificiale proprietaria di Stip ti consente di avere la tua AI personalizzata in pochissimo tempo",
        ...
        "optimizeAiTxt": "Stip opera in tempo reale e senza necessità di alcuna interazione umana, grazie alla sua AI su tre livelli",
        ...
        "accurateTitle": "Dare una risposta rapida ed efficace ai tuoi clienti è l’unica cosa che davvero conta",
        "accurateSubtitle": "Automatizzando tutte le attività del customer care sui social e sul canale email, Stip permette ai tuoi operatori di concentrarsi sull’unica cosa che conta: creare una relazione profonda con i tuoi clienti e renderli felici e soddisfatti",
        ...
        "accuratePersonalisationTitle": "Creare Relazioni Forti",
        ...
        "accurateSatisfactionTitle": "Soddisfazione del Cliente",
    ...
    "en-EN": {
        ...
        "benefitSubtitle": "Here are the results from our clients:",
