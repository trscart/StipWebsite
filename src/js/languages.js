let languages = {
    "it-IT": {
        ...
        "flow-heroSubtitle": "Stip utilizza l’Intelligenza Artificiale per ridurre del 70% la mole di lavoro dei tuoi operatori di customer service, aumentando l’efficienza del loro lavoro del 300%. I tuoi agenti non dovranno modificare il loro metodo di lavoro. Sarà Stip a prendersi cura di tutti i task di primo livello, permettendo ai tuoi operatori di concentrarsi sull’unica cosa che davvero conta: dare ai tuoi clienti una risposta veloce, efficace e personalizzata.",
        "flow1-title": "Ascolta i tuoi clienti. Ovunque si trovino",
        "flow1-subtitle": "Ogni giorno i tuoi clienti si mettono in contatto con te attraverso qualsiasi canale. Messaggi privati, Social Network, Email, Live chat, hashtags, forum, commenti… L’IA di Stip individua, comprende e categorizza tutto ciò che riguarda il tuo brand, ovunque si trovi.",
        "flow2-title": "Content Moderation automatica",
        "flow2-subtitle": "L’IA di Stip è il tuo operatore intelligente per tutte le attività di Content Moderation. Stip comprende in automatico e in tempo reale se un contenuto è rilevante per la tua azienda e ne definisce la priorità di risoluzione. Inoltre identifica e nasconde tutti i contenuti che non vuoi che siano visibili sulle tue pagine social ufficiali.",
        ...
        "flow4-title": "Invia il ticket all’operatore più adatto",
        "flow4-subtitle": "L’IA di Stip crea e categorizza automaticamente ogni ticket inserendo tutte le informazioni precedentemente raccolte. In seguito invia il ticket all’operatore o al dipartimento incaricato della risoluzione di quella specifica problematica. Il tutto sempre all’interno del tuo CRM e seguendo schemi e regole aziendali.",
        "flow-crmTitle": "Continua ad utilizzare il tuo CRM",
        "flow-crmSubtitle": "Stip si integra con tutti i CRM – proprietari o esterni – in un solo click e senza la necessità di coinvolgere il tuo dipartimento IT. I tuoi operatori non dovranno modificare il proprio metodo di lavoro o imparare ad utilizzare un’altra piattaforma.",
        "flow5-title": "Utilizza Stip Analytics e migliora il tuo customer service",
        ...
        "ourplatform-subtitle": "Se non possiedi un CRM puoi comunque utilizzare Stip e la sua semplice ed intuitiva integrated ticketing platform. Contattaci per maggiori informazioni.",
        "flow-ctaTitle": "Dai una spinta al tuo customer service!",
