let languages = {
    "it-IT": {
        ...
        "flow2-subtitle": "Never lose a single message, post, comment, emoji: Stip automatically understands your customers. Stip can decide if a message is relevant for your customer care team, can hide content from your social page that does not meet your policies and can accurately categorize every request.",
        "flow3-title": "Engage with your customers",
        "flow3-subtitle": "Stip responds automatically and in real time to public posts and moves conversations from public to private channels. We know all the information that your customer care agents need to provide a value added response. Stip AI proactively reaches out and collects all missing information.",
