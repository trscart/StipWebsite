let languages = {
    ...
    "en-EN": {
        ...
        "whatCaringTxt": "Don’t spend time on irrelevant content! Stip automatically monitors all social contents from your clients, both inside and outside your official channels. Our AI detects requests for assistance and differentiates those from contents that do not require your team’s support",
        "whatTicketTitle": "Collect all the information you need",
        "ticketTitle": "Collect information to solve every request",
        "whatTicketTxt": "Reduce the response time! Stip asks in real time all the information that your agents need to handle every request in a single step. You can get rid of multiple interactions between client and Customer Care representative",
        "whatRedirectTitle": "Choose the right operator",
        "redirectTitle": "Create and route tickets",
        "whatRedirectTxt": "Get the right ticket to the right operator. Stip understands each customer request, identifies its category and collects all the information needed, creates a categorized ticket and dispatches it automatically to the most accurate Customer Care Representative",
        ...
        "optimizeSetupTxt": "Stip is extremely flexible and allows you to customize your Artificial Intelligence in less than one week",
        "optimizeSocialTitle": "Social Listening",
